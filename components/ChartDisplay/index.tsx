...
function Reset() {
  ...
  if (format(today, "DD/MM/YY", "es") !== format_date)
    return (
      <div className="sticky top-12 inset-x-0 fade-in  z-50 sm:-mt-8 sm:top-2 pointer-events-none">
        <div className="max-w-[500px] mx-auto flex justify-start sm:justify-end px-2 ">
          <button
